...
; methods
    static Clear()                      => CBH_API.ClearHistory()
    static DeleteItem(index)            => CBH_API.DeleteHistoryItem(index) ; 1 based index
    static GetItemText(index)           => CBH_API.GetHistoryItemText(index)
    static PutItemIntoClipboard(index)  => CBH_API.PutHistoryItemIntoClipboard(index)
